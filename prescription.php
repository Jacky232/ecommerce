...
<section>
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <div class="right" style="border: 1px solid #08E;box-shadow: 1px 1px 6px #08c;padding: 53px 30px;">
                    <h1 style="font-size: 26px;margin-bottom: 30px;">Have any prescription? Upload here</h1>
                    <input type="file" id="image_input" style="margin-bottom: 30px;">
                    <button id='submit_button'>Submit</button>
                </div>
            </div>
            <div class="col-md-6">
                <div class="left" style="margin-bottom: 40px;border: 1px solid #08E;box-shadow: 1px 1px 6px #08c;padding: 53px 30px;">
                    <h1 style="font-size: 26px;margin-bottom: 30px;">Your rescription</h1>
                    <div id="display_image" style="width: 100%;height: 300px;background-position: center;background-size: cover;"></div>
                </div>
            </div>
        </div>
    </div>
